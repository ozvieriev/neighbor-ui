angular.module('app.controllers')
    .controller('userSignInController', ['$scope', '$brand', '$state', '$auth', '$form', '$zendeskApi', ($scope, $brand, $state, $auth, $form, $zendeskApi) => {
        ...
        !$zendeskApi.isEmpty() && $zendeskApi.get('currentUser').then((response) => {
