...
angular.module('app.auth').factory('$auth', ['$q', '$state', '$injector', '$authStorage', function ($q, $state, $injector, $authStorage) {
  ...
  service.signIn = function () {
    ...
    if ($state.params.returnUrl) $state.go($state.params.returnUrl);else $state.go('index');
  };
...
angular.module('app.controllers').controller('accountRecoverPasswordController', ['$scope', function ($scope) {}]);
angular.module('app.controllers').controller('accountSignInController', ['$scope', '$auth', function ($scope, $auth) {
  $scope.signIn = function () {
    $auth.signIn();
  };
}]);
angular.module('app.controllers').controller('accountSignUpController', ['$scope', function ($scope) {}]);
